  ...
  function createVideo(component) {
    ...
    playButton.click(function () {
      if (firstClick) {
        ...
        const iframePlayer = vimeoIframe
          .clone()
      ...
      $(component)
        .find('[iphone="close-button"]')
        .click(function () {
          $(this)
            .siblings('[iphone="video-play"]')
            .find("iframe[src*='https://player.vimeo.com/video/']")
            .each(function () {
